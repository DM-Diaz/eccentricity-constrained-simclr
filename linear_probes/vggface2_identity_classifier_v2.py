...
Key features (mirrors the in-domain staged classifier):
...
- !!! Sbatch takes precedence, so verify default values against sbatch parameters!!!
"""
...
def main():
    ...
    # make sure this is correct else, something goes wrong (fragile code will need to fix at some point)
    cfg = Config(
