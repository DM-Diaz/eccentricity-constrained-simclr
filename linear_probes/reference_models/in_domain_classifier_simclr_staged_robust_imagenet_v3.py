...
"""
Paper-grade in-domain classifier using SimCLR pretrained weights.
...
NOTE: !!!Sbatch params take precedence, verify against default vals!!!
"""
...
def make_label_maps(train_labels: List[str], eval_labels: List[str], unseen_policy: str) -> Tuple[Dict[str, int], Dict[int, str], List[str]]:
    ...
    if unseen and unseen_policy == "error":
        msg = (
            ...
            + "\n\n"
            + "This is expected if splits were created by *session* without label-stratification. "
